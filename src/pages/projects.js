...
const Project = ({ title, type, img, link, github }) => {
  return (
    <article className="w-full flex flex-col items-center justify-between relative rounded-3xl border border-solid border-dark bg-light p-6 dark:bg-dark dark:border-light">
...
const projects = () => {
  return (
    <>
      <Head>
        <title>illusivZ | Projects Page</title>
        <meta
          name="description"
